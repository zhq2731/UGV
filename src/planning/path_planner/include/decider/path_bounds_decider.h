...
class PathBoundsDecider {
 ...
 private:
  ...
  bool GetLaneBoundryForDisPlay(
	  const ReferenceLineInfo& reference_line_info,std::vector<std::tuple<double, double, double>>* const lane_bound);

  bool checkBlock(int idx, std::vector<std::tuple<double, double, double>>* const path_boundaries,double left_bound,double right_bound );

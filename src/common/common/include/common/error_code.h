...
{       
	...
	LOCPLANNER_PATHBOUND_DECIDER_ERR  = 0X0201,  //开辟解空间失败
	LOCPLANNER_INIT_BOUND_ERR         = 0X0202,  //初始化解空间失败
	LOCPLANNER_ROUGH_BOUND_ERR        = 0X0203,  //以道路边界生成解空间失败
    ...
    SAFE_SUB_HEART_BEAT_ERR           = 0X0E02,   //订阅心跳失败								    
	SAFE_MODEL_SHIFT_ERR              = 0X0E03,   //模式切换失败							    

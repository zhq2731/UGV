...
#ifndef CONTROL_COMMON_TRAJECTORY_ANALYZER_H_
#define CONTROL_COMMON_TRAJECTORY_ANALYZER_H_
...
public:
   ...
   */
  TrajectoryAnalyzer(
      const car::control::msgs::Trajectory *planning_published_trajectory);
   ...
   */
  car::control::msgs::TrajectoryPoint
  QueryNearestPointByAbsoluteTime(const double t) const;
   ...
   */
  car::control::msgs::TrajectoryPoint
  QueryNearestPointByRelativeTime(const double t) const;
  /**
   ...
   * @param n preview piont num for query
   * @return a point of trajectory
   */
  car::control::msgs::TrajectoryPoint
  QueryPreviewPointByPosition(const double x, const double y,
   ...
   */
  car::control::msgs::TrajectoryPoint
  QueryNearestPointByPosition(const double x, const double y) const;
   ...
   */
  car::common::msgs::PathPoint QueryMatchedPathPoint(const double x,
  ...
  void ToTrajectoryFrame(const double x, const double y, const double theta,
                         const double v,
                         const car::common::msgs::PathPoint &matched_point,
   ...
   */
  const std::vector<car::control::msgs::TrajectoryPoint> &
  trajectory_points() const;

private:
  car::common::msgs::PathPoint
  FindMinDistancePoint(const car::control::msgs::TrajectoryPoint &p0,
                       const msgs::TrajectoryPoint &p1, const double x,
                       const double y) const;

  std::vector<car::control::msgs::TrajectoryPoint> trajectory_points_;
...
#endif // CONTROL_COMMON_TRAJECTORY_ANALYZER_H_

...
#ifndef COMMON_FILTERS_DIGITAL_FILTER_COEFFICIENTS_H_
#define COMMON_FILTERS_DIGITAL_FILTER_COEFFICIENTS_H_
...
#endif  // COMMON_FILTERS_DIGITAL_FILTER_COEFFICIENTS_H_

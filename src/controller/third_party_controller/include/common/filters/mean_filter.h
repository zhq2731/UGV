...
#ifndef COMMON_FILTERS_MEAN_FILTER_H_
#define COMMON_FILTERS_MEAN_FILTER_H_
 ...
 * @brief The car::control namespace contains the code of the control module.
 */
namespace car {
namespace control {
...
#endif  // COMMON_FILTERS_MEAN_FILTER_H_

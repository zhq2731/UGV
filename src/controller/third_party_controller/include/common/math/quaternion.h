...
#ifndef COMMON_MATH_QUATERNION_H_
#define COMMON_MATH_QUATERNION_H_
...
/**
 * @namespace car::common::math
 * @brief car::common::math
 */
namespace car {
namespace common {
namespace math {
 ...
 */
inline Eigen::Vector3d QuaternionRotate(const msgs::Quaternion &orientation,
...
inline Eigen::Vector3d InverseQuaternionRotate(const msgs::Quaternion &orientation,
...
#endif /* COMMON_MATH_QUATERNION_H_ */

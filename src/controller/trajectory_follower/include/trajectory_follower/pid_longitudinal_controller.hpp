...
private:
  ...
  geometry_msgs::AccelWithCovarianceStamped::ConstSharedPtr m_current_accel_ptr{nullptr};
  autoware_msgs::TrajectoryPointArray::ConstSharedPtr m_trajectory_ptr{nullptr};

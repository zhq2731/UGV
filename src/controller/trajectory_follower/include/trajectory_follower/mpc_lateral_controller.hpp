...
public:
   ...
   * @brief constructor
   */
  explicit MpcLateralController(ros::NodeHandle &nh);
...
private:
  ...
  std::deque<autoware_msgs::TrajectoryPointArray> m_trajectory_buffer;

  // MPC object
  trajectory_follower::MPC m_mpc;

  //!< @brief measured kinematic state
  nav_msgs::Odometry::Ptr m_current_kinematic_state_ptr;
  //!< @brief measured steering
  autoware_msgs::SteeringReport::Ptr m_current_steering_ptr;
  //!< @brief reference trajectory
  autoware_msgs::TrajectoryPointArray::Ptr m_current_trajectory_ptr;
  ...
  autoware_msgs::AckermannLateralCommand m_ctrl_cmd_prev;
   ...
   */
  void setTrajectory( const autoware_msgs::TrajectoryPointArray::Ptr msg);
   ...
   */
  autoware_msgs::AckermannLateralCommand createCtrlCmdMsg(
   ...
   */
  bool isValidTrajectory(const autoware_msgs::TrajectoryPointArray & traj) const;

  bool isTrajectoryShapeChanged() const;

  bool isSteerConverged(const autoware_msgs::AckermannLateralCommand & cmd) const;

...
#include "trajectory_follower/osqp_interface/osqp_interface.hpp"

#include "trajectory_follower/osqp_interface/csc_matrix_conv.hpp"
  ...
  const std::vector<double> & u)
{
  ...
  workspace = osqp_setup(m_data.get(), m_settings.get());

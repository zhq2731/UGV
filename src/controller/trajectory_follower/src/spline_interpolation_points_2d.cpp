...
#include "trajectory_follower/interpolation/spline_interpolation_points_2d.hpp"
...
geometry_msgs::Point SplineInterpolationPoints2d::getSplineInterpolatedPoint(

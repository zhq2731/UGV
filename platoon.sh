...
then
	...
	sleep 2s
    gnome-terminal --title="chassis_driver_zt_recevier" --tab  -e 'bash -c "source ~/UGV/devel/setup.bash; rosrun chassis_driver_zt chassis_driver_zt_recevier;exec bash"'
	gnome-terminal --title="chassis_driver_zt_sender" --tab  -e 'bash -c "source ~/UGV/devel/setup.bash; rosrun  chassis_driver_zt chassis_driver_zt_sender;exec bash"'	
	sleep 1s
...
gnome-terminal --title="control-planning"   -x bash -c "source ~/UGV/devel/setup.bash; roslaunch  launch_node platoon.launch vehicle_type:=${vehicle_type_name};exec bash"
